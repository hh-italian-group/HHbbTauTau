...
namespace NSVfitStandalone {
  ...
  */
  ...
  LorentzVector boostToCOM(const LorentzVector&, const LorentzVector&);

  /// Boost a lorentz vector given in the rest frame of another lorentz vector to the laboratory frame.
  LorentzVector boostToLab(const LorentzVector&, const LorentzVector&);
  ...
  double gjAngleFromLabMomenta(const LorentzVector&, const LorentzVector&);
  ...
  double phiLabFromLabMomenta(const LorentzVector&, const LorentzVector&);
