...
void MVA_tautau(const std::string& filePath, const std::string& category_name, const std::string& suffix)
{
    ...
    const std::string output_name = "TMVA_tautau_" + category_name + "_" + suffix;
