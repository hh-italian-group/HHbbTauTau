...
enum class MoveMode { kMetropolis, kHybrid };

enum class InitMode { kUniform, kGaus, kNone };


class MarkovChainIntegrator
{
 public:
  MarkovChainIntegrator(const std::string& name, MoveMode moveMode, InitMode initMode,
